...
ELA_PSAT_9_BASELINE.config <- list(
	list(
		sgp.baseline.content.areas=c("ELA", "ELA_PSAT_9"),
		sgp.baseline.panel.years=c("2018", "2019"),
...
ELA_PSAT_10_BASELINE.config <- list(
	list(
		sgp.baseline.content.areas=c("ELA_PSAT_9", "ELA_PSAT_10"),
		sgp.baseline.panel.years=c("2018", "2019"),
		sgp.baseline.grade.sequences=c("9", "10"),
		sgp.baseline.grade.sequences.lags=1),
	list(
		sgp.baseline.content.areas=c("ELA", "ELA_PSAT_9", "ELA_PSAT_10"),
		sgp.baseline.panel.years=c("2017", "2018", "2019"),
...
ELA_SAT_BASELINE.config <- list(
	list(
		...
		sgp.baseline.grade.sequences.lags=1)#,
	# list(
	# 	sgp.baseline.content.areas=c("ELA_PSAT_9", "ELA_PSAT_10", "ELA_SAT"),
	# 	sgp.baseline.panel.years=c("2017", "2018", "2019"),
	# 	sgp.baseline.grade.sequences=c("9", "10", "11"),
	# 	sgp.baseline.grade.sequences.lags=c(1,1)),
	# ###   Skip-Year
	# ###   POTENTIAL PROBLEM - NO 2017 ELA_PSAT_9! - Equate???
	# list(
	# 	sgp.baseline.content.areas=c("ELA", "ELA_SAT"),
	# 	sgp.baseline.panel.years=c("2017", "2019"),
	# 	sgp.baseline.grade.sequences=c("9", "11"),
	# 	sgp.baseline.grade.sequences.lags=2),
	# list(
	# 	sgp.baseline.content.areas=c("ELA", "ELA", "ELA_SAT"),
	# 	sgp.baseline.panel.years=c("2016", "2017", "2019"),
