...
ELA_2015.config <- list(
	ELA.2015 = list( # 1 Year of priors
		...
		sgp.exact.grade.progression=list(list(TRUE), 8), # Repeat 'list(TRUE)' once for each grade/analysis
	...
	ELA.2015 = list( # 2 Years of priors
		...
		sgp.exact.grade.progression=list(rep(list(TRUE), 7)),
	...
	ELA.2015 = list( # 3 Years of priors
		...
		sgp.grade.sequences=list(c("3", "3", "4", "4", "5", "5", "6"), c("4", "4", "5", "5", "6", "6", "7"), c("5", "5", "6", "6", "7", "7", "8"),
			c("6", "6", "7", "7", "8", "8", "9")),
		sgp.exact.grade.progression=list(rep(list(TRUE), 6)),
