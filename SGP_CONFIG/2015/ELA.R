...
ELA_2015.config <- list(
	ELA.2015 = list( # 1 Year of priors
		...
		sgp.exact.grade.progression=list(TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE),
		sgp.projection.grade.sequences=list("NO_PROJECTIONS", "NO_PROJECTIONS", "NO_PROJECTIONS", "NO_PROJECTIONS", "NO_PROJECTIONS", "NO_PROJECTIONS", "NO_PROJECTIONS", "NO_PROJECTIONS"),
