---
title: "Appendix A to the 2018 Colorado Growth Model Report:"
...
```{r, comment=NA, results='asis', highlight=NA, echo=FALSE, goFit_ELAPSAT9}
tmp.files <- unique(gsub(".png|.pdf", "", list.files("../img/Appendices/Goodness_of_Fit/ELA_PSAT_9.2018")))
tmp.files <- tmp.files[order(tmp.files)]
...
for (gof in tmp.files) {
	...
	placeFigure(files = paste0("../img/Appendices/Goodness_of_Fit/ELA_PSAT_9.2018/", gof, ".png"), page.break= TRUE, pdf.width = tmp.width,
							caption = paste0("Goodness of Fit Plot for 2018 ELA PSAT 9 (Priors ", tmp.priors, ")."))
}
```
...
tmp.files <- unique(gsub(".png|.pdf", "", list.files("../img/Appendices/Goodness_of_Fit/ELA_PSAT_10.2018")))
tmp.files <- tmp.files[order(tmp.files)]
...
for (gof in tmp.files) {
	...
	placeFigure(files = paste0("../img/Appendices/Goodness_of_Fit/ELA_PSAT_10.2018/", gof, ".png"), page.break= TRUE, pdf.width = tmp.width,
...
tmp.files <- unique(gsub(".png|.pdf", "", list.files("../img/Appendices/Goodness_of_Fit/ELA_SAT.2018")))
tmp.files <- tmp.files[order(tmp.files)]
...
for (gof in tmp.files) { # re-order to put repeaters last
	...
	tmp.priors <- gsub(" 9", " Grade 9", tmp.priors)
	tmp.priors <- gsub(" 8", " Grade 8", tmp.priors)
	tmp.priors <- gsub("10 10", "10", tmp.priors)
	tmp.priors <- gsub("2016 2017", "2016-2017", tmp.priors)
	
	if (gof == tmp.files[1]) tmp.width <- 0.9 else tmp.width <- 1.0

	placeFigure(files = paste0("../img/Appendices/Goodness_of_Fit/ELA_SAT.2018/", gof, ".png"), page.break= TRUE, pdf.width = tmp.width,
...
```{r, comment=NA, results='asis', highlight=NA, echo=FALSE, goFit_MathPSAT9}
tmp.files <- unique(gsub(".png|.pdf", "", list.files("../img/Appendices/Goodness_of_Fit/MATHEMATICS_PSAT_9.2018")))
tmp.files <- tmp.files[order(tmp.files)]
...
for (gof in tmp.files) {
	...
	placeFigure(files = paste0("../img/Appendices/Goodness_of_Fit/MATHEMATICS_PSAT_9.2018/", gof, ".png"), page.break= TRUE, pdf.width = tmp.width,
							caption = paste0("Goodness of Fit Plot for 2018 Mathematics PSAT 9 (Priors ", tmp.priors, ")."))
}
```
...
tmp.files <- unique(gsub(".png|.pdf", "", list.files("../img/Appendices/Goodness_of_Fit/MATHEMATICS_PSAT_10.2018")))
tmp.files <- tmp.files[order(tmp.files)]

for (gof in tmp.files) {
	tmp.priors <- paste(sapply(strsplit(gof, ";")[[1]][-1], function(f) capwords(f, special.words =c("ELA", "EOCT", "PSAT", "SAT", "II"))), collapse=", ")
	...
	placeFigure(files = paste0("../img/Appendices/Goodness_of_Fit/MATHEMATICS_PSAT_10.2018/", gof, ".png"), page.break= TRUE, pdf.width = tmp.width,
...
tmp.files <- unique(gsub(".png|.pdf", "", list.files("../img/Appendices/Goodness_of_Fit/MATHEMATICS_SAT.2018")))
tmp.files <- tmp.files[order(tmp.files)]
...
for (gof in tmp.files) { # re-order to put repeaters last
	...
	placeFigure(files = paste0("../img/Appendices/Goodness_of_Fit/MATHEMATICS_SAT.2018/", gof, ".png"), page.break= TRUE, pdf.width = tmp.width,
