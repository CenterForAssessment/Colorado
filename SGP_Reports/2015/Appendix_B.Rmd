---
title: "Norm- Criterion- and Baseline-Referenced Growth"
subtitle: "An Overview of the SGP Methodology"
author:
...
```{r, echo=FALSE, include=FALSE}
  ...
  knitr::opts_chunk$set(cache.path = "_cache/Appendix_B")
...
The four panels of Figure `r paste("B", getOption("fig_caption_no")+1, sep=".")`.  depict what a student growth percentile represents in a situation considering students having only two consecutive achievement test scores.
...
<!--
###### `r figCapNo("Depiction of the distribution associated with 2011 and 2012 student scale scores together with the conditional distribution and associated growth percentile.")`
...
<h6> <strong>Fig. B.1:</strong> Depiction of the distribution associated with 2011 and 2012 student scale scores together with the conditional distribution and associated growth percentile.</h6>
<p>
<img src="../img/Appendices/SGP_Method/bidensity_p1.jpg" width=50% /> 
<img src="../img/Appendices/SGP_Method/bidensity_p2.jpg" width=50% /> 
<img src="../img/Appendices/SGP_Method/bidensity_p3.jpg" width=50% /> 
<img src="../img/Appendices/SGP_Method/bidensity_p4.jpg" width=50% />
</p>
</div>
<!-- LaTeX_Start 
\begin{figure}[H]
...
```{r, results='asis', echo=FALSE, scalescores}
	...
	cat(dualTable(ex.tbl, align=paste(rep('r', dim(ex.tbl)[2]), collapse=''), 
...
# 	colnames(t3) <- c('1<sup>st</sup>', '2<sup>nd</sup>', '3<sup>rd</sup>', '...', '10<sup>th</sup>', '...', '25<sup>th</sup>', '...', '50<sup>th</sup>', '51<sup>st</sup>', '...', '75<sup>th</sup>', '...', '90<sup>th</sup>', '...', '99<sup>th</sup>')
	colnames(t3) <- c('1st', '2nd', '3rd', '...', '10th', '...', '25th', '...', '50th', '51th', '...', '75th', '...', '90th', '...', '99th')

	cat(dualTable(t3, align=paste(rep('r', dim(t3)[2]), collapse=''), 
...
<!-- HTML_Start -->
<div class="section level6">
<h6> <strong>Fig. B.2:</strong> Linear and B-spline conditional deciles based upon bivariate math data, grades 5 and 6.</h6>
<p><img src="../img/Appendices/SGP_Method/linearquantileplot.png" width=50% /> <img src="../img/Appendices/SGP_Method/bsplinequantileplot.png" width=50% /></p>
</div>
...
where $\phi_ {i,j}$, $i=1,2,3$ and $j=1, \ldots, t-1$ denote the B-spline basis functions.  Currently, bases consisting of 7 cubic polynomials are used to "smooth" irregularities found in the multivariate assessment data.  A bivariate rendering of this is found is Figure `r paste("B", getOption("fig_caption_no"), sep=".")` where linear and B-spline conditional deciles are presented.  The cubic polynomial B-spline basis functions model the heteroscedasticity and non-linearity of the data to a greater extent than is possible using a linear parameterization.  
