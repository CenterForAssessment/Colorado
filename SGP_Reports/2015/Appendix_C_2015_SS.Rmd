---
title: "Appendix C to the 2015 Colorado PARCC Growth Model Report:"
...
```{r, echo=FALSE, include=FALSE}
  ...
  knitr::opts_chunk$set(cache.path = "_cache/Appendix_C_2015_SS", fig.path="../img/Appendices/Appendix_C_2015_SS/")
...
![](../img/Appendices/Appendix_C_2015_SS/margDist_Prior-1.png)

##### `r figCapNo("Marginal distributions of prior scale scores: Writing.")`
![](../img/Appendices/Appendix_C_2015_SS/margDist_Prior-2.png)

##### `r figCapNo("Marginal distributions of current scale scores: ELA.")`
![](../img/Appendices/Appendix_C_2015_SS/margDist_Crnt-1.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:Bidensity} {\bf{Fig. C.1:}} Marginal distributions of prior scale scores: Reading.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/margDist_Prior-1.png}
  \end{subfigure}
\end{figure}
...
\caption*{\label{fig:Bidensity} {\bf{Fig. C.2:}} Marginal distributions of prior scale scores: Writing}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/margDist_Prior-2.png}
  \end{subfigure}
\end{figure}
...
\caption*{\label{fig:Bidensity} {\bf{Fig. C.3:}} Marginal distributions of current scale scores: ELA.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/margDist_Crnt-1.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/margDist_Prior-3.png)

##### `r figCapNo("Marginal distributions of current scale scores: Mathematics.")`
![](../img/Appendices/Appendix_C_2015_SS/margDist_Crnt-2.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:Bidensity} {\bf{Fig. C.3:}} Marginal distributions of prior scale scores: Mathematics.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/margDist_Prior-3.png}
  \end{subfigure}
\end{figure}
...
\caption*{\label{fig:Bidensity} {\bf{Fig. C.4:}} Marginal distributions of current scale scores: Mathematics.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/margDist_Crnt-2.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/margDist_Crnt-3.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:Bidensity} {\bf{Fig. C.11:}} Marginal distributions of current scale scores: End-of-Course Subjects.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/margDist_Crnt-3.png}
  \end{subfigure}
\end{figure}
...
When ceiling or floor effects are present, they present themselves as dark shaded points in the extreme top-right or bottom-left corners of the plots.  This suggests that staying at the extremes from year to year is not uncommon, which may lead to odd growth estimates for these chronically high/low achieving students.  For the 2014 and 2015 Colorado data, we again see very few issues in all content area and grade combinations.  Where minor ceiling/floor effects appear in the prior year (TCAP) data, the 2015 score distributions for these students are well distributed.  That is, in plots in which a minor shaded point in the upper right corners are present the other students who scored at the HOSS on the 2014 TCAP tests had a wide range if PARCC scores, which lessens the concern for a ceiling effect^[Again, only when these academic peer groups are clustered in the HOSS/LOSS year after year do we encounter problems.].
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-1.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-2.png) 
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-3.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-4.png)

##### `r figCapNo("Conditional distribution(s) of current and prior scale scores: ELA <em>Continued</em>.")`
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-5.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-6.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-7.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-8.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistELA} {\bf{Fig. C.8:}} Conditional distribution(s) of current and prior scale scores: ELA.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-1.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-2.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-3.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-4.png}
  \end{subfigure}
\end{figure}
...
\begin{figure}[H]
\caption*{\label{fig:condDistELA2} {\bf{Fig. C.9:}} Conditional distribution(s) of current and prior scale scores: ELA \textit{Continued}.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-5.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-6.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-7.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-8.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-9.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-10.png) 
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-11.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-12.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-13.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistMath} {\bf{Fig. C.10:}} Conditional distribution(s) of current and prior scale scores: Mathematics.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-9.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-10.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-11.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-12.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOGT-13.png}
  \end{subfigure}
\end{figure}
...
```{r, echo=FALSE, include=FALSE, cache=TRUE, condDist_EOCT, fig.height=3, fig.width=3}
	...
	condDistPlot(ca="INTEGRATED_MATH_1", g="EOCT", prior.ca="2014/MATHEMATICS_7")
	condDistPlot(ca="INTEGRATED_MATH_1", g="EOCT", prior.ca="2014/MATHEMATICS_8")
	condDistPlot(ca="INTEGRATED_MATH_1", g="EOCT", prior.ca="2014/MATHEMATICS_9")

	condDistPlot(ca="INTEGRATED_MATH_2", g="EOCT", prior.ca="2014/MATHEMATICS_8")
	condDistPlot(ca="INTEGRATED_MATH_2", g="EOCT", prior.ca="2014/MATHEMATICS_9")
	condDistPlot(ca="INTEGRATED_MATH_2", g="EOCT", prior.ca="2014/MATHEMATICS_10")

	condDistPlot(ca="INTEGRATED_MATH_3", g="EOCT", prior.ca="2014/MATHEMATICS_9")
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-1.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-3.png) 
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-2.png)
<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistG9L} {\bf{Fig. C.17:}} Conditional distribution(s) of current and prior scale scores: Algebra I.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-1.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-2.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-3.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-4.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-5.png) 
<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistG9L} {\bf{Fig. C.17:}} Conditional distribution(s) of current and prior scale scores: Algebra II.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-4.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-5.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-6.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-7.png) 
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-8.png)
<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistG9L} {\bf{Fig. C.17:}} Conditional distribution(s) of current and prior scale scores: Geometry.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-6.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-7.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-8.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-9.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-10.png) 
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-11.png)
<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistG9L} {\bf{Fig. C.17:}} Conditional distribution(s) of current and prior scale scores: Integrated Math 1.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-9.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-10.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-11.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-12.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-13.png) 
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-14.png)
<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistG9L} {\bf{Fig. C.17:}} Conditional distribution(s) of current and prior scale scores: Integrated Math 2.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-12.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-13.png}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-14.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-15.png) ![](../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-16.png) 
<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:condDistG9L} {\bf{Fig. C.17:}} Conditional distribution(s) of current and prior scale scores: Integrated Math 3.}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-15.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/condDist_EOCT-16.png}
  \end{subfigure}
\end{figure}
...
`DESCRIPTIVE TEXT HERE FOR FINAL DRAFT`
...
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOGT-1.png)


##### `r figCapNo("SGP distributions for the HOSS and LOSS scores by content area and grade level.")`
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOGT-2.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:boxPlotEOGT} {\bf{Fig. C.13:}} SGP distributions for highest and lowest 50+ scale scores by content area and grade level.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOGT-1.png}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOGT-1.png}
  \end{subfigure}
\end{figure}

\begin{figure}[H]
\caption*{\label{fig:boxPlotEOGT2} {\bf{Fig. C.14:}} SGP distributions for the HOSS and LOSS scores by content area and grade level.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOGT-2.png}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOGT-2.png}
  \end{subfigure}
\end{figure}
...
```{r, echo=FALSE, include=FALSE, cache=TRUE, HOSS_Box_EOCT, fig.height=4, fig.width=7}
	...
	data.table(max.data[CONTENT_AREA %in% "GEOMETRY" & SCALE_SCORE==HOSS_1][,list(SGP_NORM_GROUP_SCALE_SCORES, SGP, Prior_Quantiles)], key='SGP')
...
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-1.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:Bidensity} {\bf{Fig. C.28:}} EOCT SGP distributions for the HOSS and LOSS scores by content area.}
  \begin{subfigure}[b]{0.95\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-1.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.95\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-1.png}
  \end{subfigure}
\end{figure}
...
<!-- HTML_Start -->
##### `r figCapNo("EOCT SGP distributions for the HOSS and LOSS scores by norm group: Algebra I.")`
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-2.png)![](../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-2.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:bpG9L} {\bf{Fig. C.29:}} EOCT SGP distributions for the HOSS and LOSS scores by norm group: Algebra I.}
  \begin{subfigure}[b]{0.95\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-2.png}
  \end{subfigure}
  \begin{subfigure}[b]{0.95\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-2.png}
  \end{subfigure}
\end{figure}
...
<!-- HTML_Start -->
##### `r figCapNo("EOCT SGP distributions for the HOSS and LOSS scores by norm group: Algebra II.")`
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-3.png)![](../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-3.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:bpAML} {\bf{Fig. C.30:}} EOCT SGP distributions for the HOSS and LOSS scores by norm group: Algebra II.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-3.png}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-3.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-4.png)![](../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-4.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:bpUSH} {\bf{Fig. C.31:}} EOCT SGP distributions for the HOSS and LOSS scores by norm group: Geometry.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-4.png}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-4.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-5.png)![](../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-5.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:bpEcon} {\bf{Fig. C.32:}} EOCT SGP distributions for the HOSS and LOSS scores by norm group: Integrated Math 1.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-5.png}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-5.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-6.png)![](../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-6.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:bpBio} {\bf{Fig. C.33:}} EOCT SGP distributions for the HOSS and LOSS scores by norm group: Integrated Math 2.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=0.93\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-6.png}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=0.93\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-6.png}
  \end{subfigure}
\end{figure}
...
![](../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-7.png)![](../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-7.png)

<!-- LaTeX_Start 
\begin{figure}[H]
\caption*{\label{fig:bpPhySci} {\bf{Fig. C.34:}} EOC SGP distributions for the HOSS and LOSS scores by norm group: Integrated Math 3.}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/HOSS_Box_EOCT-7.png}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{../img/Appendices/Appendix_C_2015_SS/LOSS_Box_EOCT-7.png}
  \end{subfigure}
\end{figure}
...
Overall there is little evidence of floor or ceiling effects in the 2015 Colorado PARCC SGP analyses.  
